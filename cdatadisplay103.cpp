...
int CDataDisplay103::DisplayAsdu1(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        if(c103Data.vec_Asdu103_1.size() > 0)
        {
            ...
            //数据单元标识符
            m_strTmp=QString::asprintf("类型标识符 = %d\n可变结构限定词--SQ = %d Num = %d\n传送原因 = %d\n公共地址 = %d\n", \
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_1.size(); i++)
        {
           ...
           //功能号和信息序号
           m_strTmp=QString::asprintf("功能类型 = %d\n信息序号 = %d\n", asdu1.nFUN, asdu1.nINF);
           strData += m_strTmp;

           //双点信息
           m_strTmp=QString::asprintf("双点信息(1-开,2-合,0/3-未用) = %d\n", \
                          asdu1.dpi.nDpi);
           strData += m_strTmp;

           //4字节时间
           m_strTmp=QString::asprintf("四字节时间 = %s\n", asdu1.ch4ByteTime);
           strData += m_strTmp;

           //附加信息
           m_strTmp=QString::asprintf("附加信息 = %d\n", asdu1.stru_sin.nSIN);
           strData += m_strTmp;
    ...
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_3.size(); i++)
        {
           ...
           for(int i = 0; i < (int)asdu3.vec_meaValue.size(); i++)
           {
               ...
               case 0:
               {
                 m_strTmp=QString::asprintf("B相电流(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                          tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               case 1:
               {
                 m_strTmp=QString::asprintf("AB线电压(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                        tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               case 2:
               {
                 m_strTmp=QString::asprintf("有功功率(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                      tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               ...
               case 3:
               {
                 m_strTmp=QString::asprintf("无功功率(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                      tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               default: break;
...
int CDataDisplay103::DisplayAsdu4(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_4.size(); i++)
        {
           ...
           //短路位置、相对时间和故障序号
           m_strTmp=QString::asprintf("短路位置 = %f\n相对时间 = %d\n故障序号 = %d\n", \
...
int CDataDisplay103::DisplayAsdu5(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_5.size(); i++)
        {
           ...
           //ASCII字符
           /*m_strTmp=QString::asprintf("ASCII1 = %d\nASCII2 = %d\nASCII3 = %d\nASCII4 = %d\nASCII5 = %d\nASCII6 = %d\nASCII7 = %d\nASCII8 = %d\n",
                          asdu5.ASCII1, asdu5.ASCII2, asdu5.ASCII3, asdu5.ASCII4, asdu5.ASCII5, asdu5.ASCII6, asdu5.ASCII7, asdu5.ASCII8);*/

           m_strTmp=QString::asprintf("ASCII1 = %c%c %c%c %c%c %c%c\n", \
                          asdu5.ASCII1, asdu5.ASCII2, asdu5.ASCII3, asdu5.ASCII4, asdu5.ASCII5, asdu5.ASCII6, asdu5.ASCII7, asdu5.ASCII8);
           strData += m_strTmp;

           //自由赋值
           m_strTmp=QString::asprintf("自由赋值1 = %d\n自由赋值2 = %d\n自由赋值3 = %d\n自由赋值4 = %d\n", \
...
int CDataDisplay103::DisplayAsdu6(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_6.size(); i++)
        {
           ...
           //7字节时间
           m_strTmp=QString::asprintf("七字节时间 = %s\n", asdu6.ch7ByteTime);
           strData += m_strTmp;
...
int CDataDisplay103::DisplayAsdu8(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_8.size(); i++)
        {
           ...
           //扫描序号
           m_strTmp=QString::asprintf("扫描序号 = %d\n", asdu8.scn.nSCN);
           strData += m_strTmp;
    ...
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_9.size(); i++)
        {
           ...
           for(int i = 0; i < (int)asdu9.dui.vsq.nVsq; i++)
           {
               ...
               case 0:
               {
                 m_strTmp=QString::asprintf("A相电流(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                          tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               case 1:
               ...
               case 2:
               {
                 m_strTmp=QString::asprintf("C相电流(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                      tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               ...
               case 3:
               {
                 m_strTmp=QString::asprintf("A相电压(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                      tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               case 4:
               {
                 m_strTmp=QString::asprintf("B相电压(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                          tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               case 5:
               {
                 m_strTmp=QString::asprintf("C相电压(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                        tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
               case 6:
               ...
               case 8:
               {
                 m_strTmp=QString::asprintf("频率(溢出位 = %d 差错位 = %d 备用位 = %d 被测值 = %f)\n", \
                          tempMEA.nOV, tempMEA.nER, tempMEA.nRES, tempMEA.fMVAL);
                 strData += m_strTmp;
               }break;
...
int CDataDisplay103::DisplayAsdu10(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_10.size(); i++)
        {
           ...
           //通用分类数据集数目
           m_strTmp=QString::asprintf("数目 = %d\n后续状态位 = %d\n\n", \
           ...
           for(int i = 0; i < (int)asdu10.ngd.nNo; i++)
           {
               ...
               //通用分类标识序号
               m_strTmp=QString::asprintf("组号 = %d\n条目号 = %d\n\n", \
                          temp.gin.nGroup, temp.gin.nEntry);
               strData += m_strTmp;

               //描述类别
               m_strTmp=QString::asprintf("描述类别 = %d  : ", \
                                temp.nKod);
               strData += m_strTmp;
               ...
               {
               case 0:
                   m_strTmp=QString::asprintf("无所指定的描述类别\n\n");
                   strData += m_strTmp;
                   break;
               case 1:
                   m_strTmp=QString::asprintf("实际值\n\n");
                   strData += m_strTmp;
                   break;
               case 2:
                   m_strTmp=QString::asprintf("缺省值\n\n");
                   strData += m_strTmp;
                   break;
               case 3:
                   m_strTmp=QString::asprintf("量程（最小值、最大值、步长\n\n");
                   strData += m_strTmp;
                   break;

               case 5:
                   m_strTmp=QString::asprintf("精度（n，m\n\n");
                   strData += m_strTmp;
                   break;
               case 6:
                   m_strTmp=QString::asprintf("因子\n\n");
                   strData += m_strTmp;
                   break;
               case 7:
                   m_strTmp=QString::asprintf("%参比\n\n");
                   strData += m_strTmp;
                   break;
               case 8:
                   m_strTmp=QString::asprintf("列表\n\n");
                   strData += m_strTmp;
                   break;
               case 9:
                   m_strTmp=QString::asprintf("量纲\n\n");
                   strData += m_strTmp;
                   break;
               case 10:
                   m_strTmp=QString::asprintf("描述\n\n");
                   strData += m_strTmp;
                   break;

               case 12:
                   m_strTmp=QString::asprintf("口令条目\n\n");
                   strData += m_strTmp;
                   break;
               case 13:
                   m_strTmp=QString::asprintf("只读\n\n");
                   strData += m_strTmp;
                   break;
               case 14:
                   m_strTmp=QString::asprintf("只写\n\n");
                   strData += m_strTmp;
                   break;
               case 19:
                   m_strTmp=QString::asprintf("相应的功能类型和信息序号\n\n");
                   strData += m_strTmp;
                   break;
               case 20:
                   m_strTmp=QString::asprintf("相应的事件\n\n");
                   strData += m_strTmp;
                   break;
               case 21:
                   m_strTmp=QString::asprintf("列表的文本阵列\n\n");
                   strData += m_strTmp;
                   break;
               case 22:
                   m_strTmp=QString::asprintf("列表的值阵列\n\n");
                   strData += m_strTmp;
                   break;
               case 23:
                   m_strTmp=QString::asprintf("相关联的条目\n\n");
                   strData += m_strTmp;
                   break;

               default:
                   m_strTmp=QString::asprintf("备用\n\n");
                   strData += m_strTmp;
                   break;
               }

               //通用分类数据描述
               m_strTmp=QString::asprintf("数据宽度 = %d\n数目 = %d\n后续状态位 = %d\n数据类型 = %d\n\n", \
               ...
               for(unsigned int i =0; i < temp.gdd.nNum; i++)
               {
                  ...
                  case 0:
                  {
                    m_strTmp=QString::asprintf("无数据\n");
                    strData += m_strTmp;
                  }break;
                  case 1:
                  {
                      m_strTmp=QString::asprintf("ASCII八位码 = %c\n", tempgid.ASCII);
                      strData += m_strTmp;
                  }break;
                  case 2:
                  {
                      m_strTmp=QString::asprintf("成组八位串 = %d %d %d %d\n", \
                                       tempgid.bsi.chBsi[0], tempgid.bsi.chBsi[1], tempgid.bsi.chBsi[2], tempgid.bsi.chBsi[3]);
                      strData += m_strTmp;
                  }break;
                  case 3:
                  {
                      m_strTmp=QString::asprintf("无符号整数 = %u\n", tempgid.UnnValue);
                      strData += m_strTmp;
                  }break;
                  case 4:
                  {
                      m_strTmp=QString::asprintf("整数 = %d\n", tempgid.nValue);
                      strData += m_strTmp;
                  }break;
                  case 5:
                  {
                      m_strTmp=QString::asprintf("无符号浮点数 = %f\n", tempgid.UnfValue);
                      strData += m_strTmp;
                  }break;
                  case 6:
                  {
                      m_strTmp=QString::asprintf("浮点数 = %lf\n", tempgid.fValue);
                      strData += m_strTmp;
                  }break;
                  case 7:
                  {
                      m_strTmp=QString::asprintf("IEEE标准754短实数 = %f\n", tempgid.R32);
                      strData += m_strTmp;
                  }break;
                  case 8:
                  {
                      m_strTmp=QString::asprintf("IEEE标准754实数 = %lf\n", tempgid.R64);
                      strData += m_strTmp;
                  }break;
                  case 9:
                  {
                      m_strTmp=QString::asprintf("双点信息 = %d\n", tempgid.dpi.nDpi);
                      strData += m_strTmp;
                  }break;
                  case 10:
                  {
                      m_strTmp=QString::asprintf("单点信息 = %d\n", tempgid.spi.nSpi);
                      strData += m_strTmp;
                  }break;
                  case 11:
                  {
                      m_strTmp=QString::asprintf("带瞬变和差错的双点信息 = %d\n", tempgid.nTEDPI);
                      strData += m_strTmp;
                  }break;
                  case 12:
                  {
                      m_strTmp=QString::asprintf("带品质描述词的被测值:\n溢出位 = %d 差错位 = %d 被测值 = %f\n", \
                  ...
                  case 14:
                  {
                      m_strTmp=QString::asprintf("7个8位二进制时间 = %s\n", tempgid.ch7ByteTime);
                      strData += m_strTmp;
                  }break;
                  case 15:
                  {
                      m_strTmp=QString::asprintf("通用分类标识序号:\n组号 = %d 条目号 = %d", tempgid.gin.nGroup, tempgid.gin.nEntry);
                      strData += m_strTmp;
                  }break;
                  case 16:
                  {
                      m_strTmp=QString::asprintf("相对时间 = %d", tempgid.ret.nRET);
                      strData += m_strTmp;
                  }break;
                  case 17:
                  {
                      m_strTmp=QString::asprintf("功能类型和信息序号:\n功能类型 = %d 信息序号 =%d", tempgid.nFUN, tempgid.nINF);
                      strData += m_strTmp;
                  }break;
                  case 18:
                  {
                      m_strTmp=QString::asprintf("带时标的报文:\n双点信息 = %d\n四字节时间 = %s\n附加信息 = %d\n", \
                                       tempgid.dpiwitime.dpi.nDpi, tempgid.dpiwitime.ch4ByteTime, tempgid.dpiwitime.sin);
                      strData += m_strTmp;
                  }break;
                  case 19:
                  {
                      m_strTmp=QString::asprintf("带相对时间的时标报文:\n双点信息 = %d\n相对时间 = %d\n故障序号 = %d\n四字节时间 = %s\n附加信息 = %d\n", \
                  ...
                  case 20:
                  {
                      m_strTmp=QString::asprintf("带相对时间的时标的被测值:\n被测值 = %f\n 相对时间 = %d\n故障序号 = %d\n四字节时间 = %s\n", \
                                       tempgid.valwiret.R32, tempgid.valwiret.ret, tempgid.valwiret.fan, tempgid.valwiret.ch4ByteTime);
                      strData += m_strTmp;
                  }break;
                  case 21:
                  {
                      m_strTmp=QString::asprintf("外部文本序号\n");
                      strData += m_strTmp;
                  }break;
                  case 22:
                  {
                      m_strTmp=QString::asprintf("通用分类回答码 = %d\n", tempgid.grc.nGrc);
                      strData += m_strTmp;
                  }break;
                  case 23:
                  {
                      m_strTmp=QString::asprintf("数据结构\n");
                      strData += m_strTmp;
                  }break;
                  case 24:
                  {
                      m_strTmp=QString::asprintf("索引\n");
                      strData += m_strTmp;
                  }break;
...
int CDataDisplay103::DisplayAsdu26(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_26.size(); i++)
        {
           ...
           //扰动信息
           m_strTmp=QString::asprintf("扰动值类型 = %d\n故障序号 = %d\n电网故障序号 = %d\n通道数目 = %d\n一个通道信息元素的数目 = %d\n信息元素间的间隔 = %d\n", \
...
int CDataDisplay103::DisplayAsdu27(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        if(c103Data.vec_Asdu103_27.size() > 0)
        {
            ...
            //数据单元标识符
            m_strTmp=QString::asprintf("类型标识 = %d\n可变结构限定词--SQ = %d Num = %d\n传送原因 = %d\n公共地址 = %d\n", \
...
int CDataDisplay103::DisplayAsdu30(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_30.size(); i++)
        {
           ...
           //
           m_strTmp=QString::asprintf("每个Asdu有关扰动值的数目 = %d\nAsdu的第一个信息元素序号 = %d\n", asdu30.ndv.nNDV, asdu30.nfe.nNFE);
           strData += m_strTmp;

           for(int i = 0; i < (asdu30.ndv.nNDV); i++)
           {
               m_strTmp=QString::asprintf("单个扰动值%d = %f\n", i+1, asdu30.sdv[i]);
               strData += m_strTmp;
           }
...
int CDataDisplay103::DisplayAsdu31(CC103Data &c103Data, QString &strData)
{
    try
    {
        ...
        for(int i = 0; i < (int)c103Data.vec_Asdu103_31.size(); i++)
        {
           ...
           m_strTmp=QString::asprintf("命令类型 = %d\n扰动值类型 = %d\n故障序号 = %d\n实际通道 = %d\n", \

...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    QString rgStr;
    rgStr =  rgStr.asprintf("[0-9a-fA-F]{%d}", str.length());
    ...
    case 0://101Aadu解析
    {
        ...
        {
            QString errStr;
            errStr.asprintf("%s", c101.GetLastLogMsg());
    ...
    case 1://103Asdu解析
    {
        ...
        {
            QString errStr;
            errStr.asprintf("%s", c103.GetLastLogMsg());
    ...
    case 2://四方UDP或TCP103报文解析
    {
           ...
           {
               QString errStr;
               errStr.asprintf("%s", csf103udp.GetLastLogMsg());
               QMessageBox::warning(this, "Analyze 103 Message Error", errStr);
               break;
           }
